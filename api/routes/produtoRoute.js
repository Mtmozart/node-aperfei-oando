...
router
  .post('/produto',  roles([""]), ProdutoController.cadastrarProduto)
  .get('/produto',  permissoesRoles([""]),ProdutoController.buscarTodosProdutos)
  .get('/produto/id/:id',permissoes([""]), ProdutoController.buscarProdutoPorId)
